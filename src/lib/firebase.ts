...
const missingVars = essentialEnvVars.filter(envVar => !process.env[envVar]);
...
const firebaseConfig = {
  ...
  measurementId: process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID, // measurementId is optional for basic auth
};
